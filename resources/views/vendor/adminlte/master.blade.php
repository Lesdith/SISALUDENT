...
@yield('title_postfix', config('adminlte.title_postfix', ''))</title>
    ...
    @endif
     ...
     @if(config('adminlte.plugins.sweetalert'))
        <!-- Select2 -->
        <link rel="stylesheet" href="{{ asset('vendor/adminlte/vendor/sweetalert2/sweetalert2.min.css') }}">
    @endif
...
@endif
  ...
  @if(config('adminlte.plugins.sweetalert'))
        <!-- Select2 -->
    <script src="{{ asset('vendor/adminlte/vendor/sweetalert2/sweetalert2.min.js') }}"></script>
    @endif
